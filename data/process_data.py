...
def clean_data(df):
    '''
    Clean merged data generated from load_data function

    Args:
        df: merged data generated from load_data function
    ...
    # Remove rows whose value equal to 2 in the column 'related'
    df = df[df['related']!=2]
    # Remove duplicates
